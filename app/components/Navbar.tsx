            ...
            {mounted && (
              user ? (
                ...
                <div className="relative">
                  ...
                  <div id="login-modal" style={{ display: 'none', position: 'absolute', right: 0, top: '40px', background: '#161b22', border: '1px solid #30363d', borderRadius: '10px', padding: '12px', flexDirection: 'column', gap: '8px', zIndex: 200, minWidth: '160px' }}>
                    <p style={{ fontFamily: 'monospace', fontSize: '10px', color: '#484f58', margin: '0 0 4px' }}>// 로그인 방법 선택</p>
                    <button onClick={() => handleLogin('google')}
                      style={{ background: '#21262d', border: '1px solid #30363d', borderRadius: '6px', padding: '8px 12px', color: '#e6edf3', fontSize: '12px', fontFamily: 'monospace', cursor: 'pointer', display: 'flex', alignItems: 'center', gap: '8px', width: '100%' }}
                      onMouseOver={e => (e.currentTarget.style.borderColor = '#58a6ff')}
                      onMouseOut={e => (e.currentTarget.style.borderColor = '#30363d')}>
                    ...
                    <button onClick={() => handleLogin('kakao')}
                      style={{ background: '#FEE500', border: '1px solid #FEE500', borderRadius: '6px', padding: '8px 12px', color: '#191919', fontSize: '12px', fontFamily: 'monospace', cursor: 'pointer', display: 'flex', alignItems: 'center', gap: '8px', width: '100%' }}
                      onMouseOver={e => (e.currentTarget.style.opacity = '0.85')}
                      onMouseOut={e => (e.currentTarget.style.opacity = '1')}>
                      <svg width="14" height="14" viewBox="0 0 24 24" fill="#191919"><path d="M12 3C6.48 3 2 6.48 2 10.8c0 2.7 1.68 5.07 4.2 6.48l-1.08 3.96L9.6 18.9c.78.12 1.58.18 2.4.18 5.52 0 10-3.48 10-7.8S17.52 3 12 3z"/></svg>
                      카카오로 로그인
                    </button>
                  </div>
                </div>
