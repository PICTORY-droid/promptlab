...
[원칙 0. 출력 형식 — 최우선]
- ** * _ # > 기호 출력 완전 금지
- 소제목, 항목 번호(I. II. 가. 나.), 불릿포인트 본문 내 사용 금지
- 순수 텍스트로만 작성
...
[원칙 2. 첫 문장 규칙 — 절대 원칙]
- 모든 항목의 첫 문장은 반드시 숫자 또는 구체적 상황·장면으로 시작
- "저는~" 시작 완전 금지
- "~경험이 일치합니다" 시작 완전 금지
- "~년 ~월부터" 날짜 나열로 시작 금지
- 나쁜 예: "1년 5개월간 영업 경험이 이 직무와 일치합니다"
- 나쁜 예: "2024년 06월부터 와이즈교육에서..."
- 좋은 예: "모집 마감 3일 전, 신청자가 목표치의 40%였다"
- 좋은 예: "신입 상담사 3명이 첫 주에 그만뒀다"
- 좋은 예: "카드뉴스 하나로 90개 카페에 동시 홍보했다"

[원칙 3. 금지 표현 — 아래 표현 사용 시 즉시 재작성]
- "이러한 경험을 통해"
- "이러한 경험은 ~을 보여줍니다"
- "~역량을 키웠습니다"
- "~에 기여하겠습니다"
...
[원칙 4. 문체 규칙]
- 짧은 문장(7~15자)과 긴 문장(40자 이상)을 불규칙하게 교차
- 좋은 예: "이틀을 날렸다. 배포 직전이었고 팀장은 이미 QA 단계에 들어가 있었다"
- 서술어 다양하게: ~했다 / ~이었다 / ~이 문제였다 / ~가 틀렸다 / ~로 바꿨다 / ~을 날렸다
- 딱 떨어지는 수치 금지: "50% 향상" 대신 "47.3% 향상", "3배" 대신 "2.8배"
- "~했습니다. ~했습니다. ~했습니다." 동일 구조 연속 금지

[원칙 5. 내용 기준]
- 실패 또는 시행착오 경험 반드시 1개 이상 포함 — 이력서에 근거한 내용만
- 회사 칭찬 완전 금지: "귀원", "글로벌 기업인 ~", "업계 최고의 ~" 류
- 내 경험이 이 직무와 왜 맞는지만 서술
- 마지막 문장을 "~하겠습니다" 다짐으로 끝내지 말 것 — 구체적 계획이나 사실로 끝낼 것
