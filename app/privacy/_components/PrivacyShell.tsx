  ...
  return (
    <PageShell>
      ...
      <div className="grid gap-3 sm:gap-4">
        ...
        <PrivacySection
          title="4. 보유 및 이용 기간"
          description="개인정보는 처리 목적별 기준에 따라 보유하며, 목적 달성 또는 삭제 요청 처리 후에는 필요한 범위에서 삭제합니다."
          items={[
        ...
        <PrivacySection
          title="6. 외부 서비스 이용 현황"
          description="PromptLab은 인증, 데이터베이스, 배포, 문의 접수, 사용 분석을 위해 외부 서비스를 사용합니다."
          items={[
        ...
        <PrivacySection
          ...
          description="개인정보 문의, 오류 제보, 계정·데이터 삭제 요청은 Contact 페이지를 통해 접수합니다."
          items={[
            "서비스명: PromptLab",
        ...
        <PrivacySection
          title="13. 만 14세 미만 아동의 개인정보 처리"
          description="PromptLab은 만 14세 미만 아동을 주요 대상으로 제공되는 서비스가 아닙니다."
          items={[
