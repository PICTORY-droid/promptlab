      ...
      <div className="grid gap-3 sm:gap-4">
        <PrivacySection
          ...
          items={[
            ...
            "SafeCheck 기록: 위험 점수, 판정, 위험 카테고리, 안전 문장 안내, 정책 버전, 저장기 버전, 검사 시각이 저장될 수 있습니다.",
        ...
        <PrivacySection
          ...
          items={[
            ...
            "SafeCheck 리포트에는 회사기밀, 내부자료, 계약조건 같은 민감한 원문을 저장하지 않는 것을 원칙으로 합니다.",
            "SafeCheck 리포트에는 상담기록, 진료기록 같은 민감한 원문을 저장하지 않는 것을 원칙으로 합니다.",
        ...
        <PrivacySection
          ...
          items={[
            ...
            "SafeCheck 검사 기록은 서비스 내 기록 확인을 위해 보유될 수 있으며, 삭제 요청이 있는 경우 확인 후 삭제될 수 있습니다.",
            "Contact 문의 정보는 문의 처리와 이력 확인에 필요한 기간 동안 보유될 수 있습니다.",
            "접속 로그, 오류 로그, 사용 분석 정보는 서비스 안정성 확인과 개선에 필요한 기간 동안 외부 서비스의 보존 정책에 따라 처리될 수 있습니다.",
            "법령상 보관 의무, 분쟁 대응, 보안 사고 조사 등 정당한 사유가 있는 경우 해당 목적에 필요한 범위에서 일정 기간 보관될 수 있습니다.",
          ]}
        />
        ...
        <PrivacySection
          ...
          items={[
            ...
            "외부 서비스는 각 서비스의 보안 정책과 개인정보 처리방침에 따라 데이터를 처리합니다.",
          ]}
        />
        ...
        <PrivacySection
          ...
          items={[
            ...
            "계정 또는 저장 데이터 삭제가 필요한 경우 Contact 페이지 또는 개인정보 문의 메일로 요청할 수 있습니다.",
